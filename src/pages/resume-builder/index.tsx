      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Tabs defaultValue="templates" className="w-full">
          <div className="flex justify-center mb-8">
            <TabsList className="grid grid-cols-3 md:grid-cols-6 bg-white border">
              <TabsTrigger value="templates" className="flex items-center gap-2 text-ehrdc-teal">
                <FileText className="h-4 w-4" />
                <span className="hidden sm:inline">Templates</span>
              </TabsTrigger>
              <TabsTrigger value="suggestions" className="flex items-center gap-2 text-ehrdc-teal">
                <Lightbulb className="h-4 w-4" />
                <span className="hidden sm:inline">Suggestions</span>
              </TabsTrigger>
              <TabsTrigger value="ats" className="flex items-center gap-2 text-ehrdc-teal">
                <Target className="h-4 w-4" />
                <span className="hidden sm:inline">ATS</span>
              </TabsTrigger>
              <TabsTrigger value="analytics" className="flex items-center gap-2 text-ehrdc-teal">
