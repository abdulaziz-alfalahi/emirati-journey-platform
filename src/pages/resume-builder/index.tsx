...
const ResumeBuilderPage: React.FC = () => {
  ...
  // Define tabs for the main content
  const tabs = [
    {
      id: 'templates',
      label: 'Templates',
  ...
  return (
    <CareerPageLayout
      ...
      primaryActionIcon={<Play className="h-5 w-5" />}
      primaryActionOnClick={() => {
        // Scroll to templates tab
        const templatesTab = document.querySelector('[data-state="active"][value="templates"]');
        if (templatesTab) {
          templatesTab.scrollIntoView({ behavior: 'smooth' });
        }
      }}
