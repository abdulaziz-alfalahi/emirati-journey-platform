...
import { Star, Award, TrendingUp, Users, Send, Eye, Share2, FileText, MessageCircle } from 'lucide-react';
...
const ShareSuccessStoriesPage: React.FC = () => {
  ...
  const stats = [
    ...
    { value: "85%", label: "Career Growth Rate", icon: TrendingUp },
    { value: "200+", label: "Monthly Submissions", icon: Send }
  ];
  ...
  const tabs = [shareFormTab, storiesTab];
  ...
  if (loading) {
    return (
      <LifelongEngagementLayout
        title="Share Your Success Story: Inspire Others"
        description="Your journey can light the way for someone else. Share your achievements and inspire our community."
