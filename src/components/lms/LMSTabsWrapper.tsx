...
export const LMSTabsWrapper: React.FC<LMSTabsWrapperProps> = ({
  ...
  console.log('LMSTabsWrapper: Rendering with props:', {
    user: !!user,
    isInstructor,
  ...
  try {
    ...
    console.error('LMSTabsWrapper: Error rendering:', error);
    return <div>Error loading LMS tabs. Please refresh the page.</div>;
  }
};
