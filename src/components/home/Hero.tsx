...
const Hero: React.FC = () => {
  ...
  return <section className="relative min-h-[75vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden pt-8 pb-8 md:pt-12 md:pb-12">
      ...
      <div className="container px-6 relative z-10">
        ...
        {/* Scroll Indicator - Moving down more with bottom spacing of 1 */}
        <div className={`absolute bottom-1 left-1/2 transform -translate-x-1/2 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
