...
import { Search, Globe, ChevronDown, Menu, Accessibility, Phone, Mail, X } from 'lucide-react';
      ...
      <div className="bg-ehrdc-teal text-white">
        <div className="dubai-container">
          <div className="flex justify-between items-center py-2 text-sm">
            ...
            {/* Right side - Contact and services */}
            <div className="flex items-center space-x-4">
              ...
              {/* Accessibility Menu */}
              <DropdownMenu open={isAccessibilityOpen} onOpenChange={setIsAccessibilityOpen}>
                ...
                <DropdownMenuContent align="end" className="w-48 bg-white border border-ehrdc-neutral-light shadow-lg">
